    ...
    <div className="page">
      <header className="header">
        ...
        <nav className={menuOpen ? "nav open" : "nav"}>
          ...
          <a href="#ingredients" onClick={() => setMenuOpen(false)}>Ingredients</a>
          <a href="#recipes" onClick={() => setMenuOpen(false)}>Recipes</a>
          <a href="#order" onClick={() => setMenuOpen(false)} className="nav-order">Order</a>
        </nav>
      ...
      <section id="home" className="hero">
        <div className="hero-text">
          ...
          <div className="hero-actions">
            ...
            <button onClick={orderNow} className="whatsapp mini">
      ...
      <section className="quick-strip">
        <a href="#product"><Leaf size={17} /> Product</a>
        <a href="#benefits"><Sparkles size={17} /> Benefits</a>
        <a href="#ingredients"><Star size={17} /> Ingredients</a>
        <a href="#order"><MessageCircle size={17} /> Order</a>
      </section>
      ...
      <section id="product" className="section">
        ...
        <div className="product-box">
          ...
          <div className="product-info">
            <p className="small">250g pack</p>
            <h3>Sathu Mix</h3>
            <p>
              A traditional wellness mix made with millets, pulses, nuts and seeds.
              Designed for daily nourishment, natural strength, stamina and glow.
            </p>
      ...
      <section id="benefits" className="section benefits-section">
        ...
        <div className="benefit-grid">
          ...
          <div><Star /> Stamina</div>
          <div><Heart /> Health & strength</div>
